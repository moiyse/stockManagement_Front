                ...
                <div className='col-md-12'>
                  ...
                  >
                    <div className='card-body p-lg-12'>
                      <h1>Welcome back! EcoWaste</h1>
                      <p>
                        EcoWaste is simple & clean design for developer and
                        designer.
                      </p>
                  ...
                  <div className='card h-100 card-lg'>
                    <div className='card-body p-6'>
                      ...
                      <div className='lh-1'>
                        ...
                        <span>
                          <span className='text-dark me-1'>35+</span>New Sales
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='card h-100 card-lg'>
                    <div className='card-body p-6'>
                      ...
                      <div className='lh-1'>
                        ...
                        <span>
                          <span className='text-dark me-1'>30+</span>new in 2
                          days
                        </span>
                      </div>
                    </div>
