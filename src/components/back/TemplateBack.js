                                ...
                                <div className="navbar-vertical">
                                                ...
                                                <div className="navbar-vertical-content flex-grow-1" data-simplebar="">
                                                    <ul className="navbar-nav flex-column">
                                                        ...
                                                        <li className="nav-item mt-6 mb-3">
                                                            <span className="nav-label">Site Settings</span> <span className="badge bg-light-info text-dark-info">Coming Soon</span></li>
                                                        <li className="nav-item ">
                                                        ...
                                                        <li className="nav-item mt-6 mb-3">
                                                            <span className="nav-label">Support</span> <span className="badge bg-light-info text-dark-info">Coming Soon</span></li>
                                                        <li className="nav-item ">
                                                            <a className="nav-link disabled" href="#!">
                                                                <div className="d-flex align-items-center">
                                                        ...
                                                        <li className="nav-item mt-6 mb-3">
                                                            <span className="nav-label">Our Apps</span></li>
                                                        <li className="nav-item ">
                                                            <a className="nav-link disabled" href="#!">
                                                                <div className="d-flex align-items-center">
                                                        ...
                                                        <li id="navMenuLevel" className="collapse "
                                                        data-bs-parent="#sideNavbar">
                                                        <ul className="nav flex-column">
                                                            <li className="nav-item">
                                ...
                                <div className="card h-100 card-lg">
                                    ...
                                    <div className="card-body p-6">
                                        ...
                                        <div className="d-flex justify-content-between align-items-center mb-6">
                                            ...
                                            <div
                                                className="icon-shape icon-md bg-light-danger text-dark-danger rounded-circle">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <select className="form-select ">
                                                ...
                                                <option defaultValue="2023">2020</option>
                                                <option defaultValue="2024">2021</option>
                                                <option defaultValue="2025">2022</option>
                                                <option defaultValue="2025">2023</option>
                                            </select>
                                        </div>
                                ...
                                <div className="card-body p-6">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <ul className="list-unstyled mb-0">
                                            <li className="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8"
                                                    height="8" fill="currentColor"
                                                    className="bi bi-circle-fill text-primary" viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span className="ms-1"><span className="text-dark">Shippings
                                                        $32.98</span> (2%)</span></li>
                                            <li className="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8"
                                                    height="8" fill="currentColor"
                                                    className="bi bi-circle-fill text-warning" viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span className="ms-1"><span className="text-dark">Refunds $11</span>
                                                    (11%)</span></li>
                                            <li className="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8"
                                                    height="8" fill="currentColor" className="bi bi-circle-fill text-danger"
                                                    viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span className="ms-1"><span className="text-dark">Order $14.87</span>
                                                    (1%)</span></li>
                                            <li><svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"
                                                    fill="currentColor" className="bi bi-circle-fill text-info"
                                                    viewBox="0 0 16 16">
                                                    <circle cx="8" cy="8" r="8" />
                                                </svg> <span className="ms-1"><span className="text-dark">Income 3,271</span>
                                                    (86%)</span></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div>
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                    fill="currentColor" className="bi bi-bell text-warning"
                                                    viewBox="0 0 16 16">
                                                    <path
                                            ...
                                            <div className="ms-4">
                                                ...
                                                <p className="mb-0">You have <a className="link-info" href="#!">2 new
                                                        notification</a></p>
                                            </div>
                                        ...
                                        <table className="table table-centered table-borderless text-nowrap table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            className="badge bg-light-danger text-dark-danger">Cancel</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            className="badge bg-light-info text-dark-info">Processing</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
