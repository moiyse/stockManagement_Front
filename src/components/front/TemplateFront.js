    ...
    <div className="container">
      <div className="row w-100 align-items-center gx-lg-2 gx-0">
        ...
        <div className="col-md-2 col-xxl-3 d-none d-lg-block">
          <button type="button" className="btn  btn-outline-gray-400 text-muted" data-bs-toggle="modal"
      ...
      <div className="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
          ...
          <ul className="navbar-nav align-items-center ">
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li><a className="dropdown-item" href="pages/index-4.html">Home 4 <span
                      className="badge bg-light-info text-dark-info ms-1">New</span></a></li>
              </ul>
            </li>
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              ...
              <ul className="dropdown-menu">
                ...
                <li><a className="dropdown-item" href="pages/shop-single-2.html">Shop Single v2<span
                      className="badge bg-light-info text-dark-info ms-1">New</span></a></li>
            ...
            <li className="nav-item dropdown dropdown-flyout">
              <a className="nav-link" href="#" id="navbarDropdownDocs" role="button" data-bs-toggle="dropdown"
              ...
              <div className="dropdown-menu dropdown-menu-lg" aria-labelledby="navbarDropdownDocs">
                <a className="dropdown-item align-items-start" href="docs/index.html">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                      className="bi bi-file-text text-primary" viewBox="0 0 16 16">
                      <path
                ...
                <a className="dropdown-item align-items-start" href="docs/changelog.html">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                      className="bi bi-layers text-primary" viewBox="0 0 16 16">
                      <path
        ...
        <div className="d-block d-lg-none h-100" data-simplebar="">
          <ul className="navbar-nav ">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li className="dropdown-submenu ">
                  ...
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Milk Drinks</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Curd & Yogurt</a></li>
                    <li> <a className="dropdown-item" href="pages/shop-grid.html">Eggs</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Buns & Bakery</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Cheese</a></li>
                    <li> <a className="dropdown-item" href="pages/shop-grid.html">Condensed Milk</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Dairy Products</a></li>
                  </ul>
                </li>
                <li className="dropdown-submenu ">
                  <a className="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">
                  ...
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Vegetables</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Fruits</a></li>
                    <li> <a className="dropdown-item" href="pages/shop-grid.html">Exotics & Premium</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Fresh Sprouts</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Frozen Veg</a></li>
                  </ul>
                </li>
                <li className="dropdown-submenu ">
                  <a className="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">
                  ...
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Soft Drinks</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Fruit Juices</a></li>
                    <li> <a className="dropdown-item" href="pages/shop-grid.html">Coldpress</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Soda & Mixers</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Milk Drinks</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Health Drinks</a></li>
                    <li><a className="dropdown-item" href="pages/shop-grid.html">Herbal Drinks</a></li>
                  </ul>
                </li>
              </ul>
            </li>
            ...
            <li className="nav-item dropdown dropdown-flyout">
              <a className="nav-link" href="#" id="navbarDropdownDocs2" role="button" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                Docs
              </a>
              <div className="dropdown-menu dropdown-menu-lg" aria-labelledby="navbarDropdownDocs2">
                <a className="dropdown-item align-items-start" href="docs/index.html">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                      className="bi bi-file-text text-primary" viewBox="0 0 16 16">
        ...
        <div className="row align-items-center">
          ...
          <div className="col-3 col-md-3 col-lg-3">
            ...
            <div className="input-group input-spinner  ">
              ...
              <input type="number" step="1" max="10" defaultValue="1" name="quantity"
  ...
  <section className="mt-8">
    <div className="container">
      <div className="hero-slider ">
        <div
          style={{backgroundSize: 'cover', borderRadius: '.5rem', backgroundPosition: 'center'}}>
        ...
        <div className=" "
          ...
          <div className="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
            ...
            <h2 className="text-dark display-5 fw-bold mt-4">Free Shipping on <br/> orders over <span
                className="text-primary">$100</span></h2>
            <p className="lead">Free Shipping to First-Time Customers Only, After promotions and discounts are applied.
            </p>
            <a href="#!" className="btn btn-dark mt-3">Shop Now <i className="feather-icon icon-arrow-right ms-1"></i></a>
          </div>
...
<div className="slick-list draggable"><div className="slick-track" style={{opacity: '1', width: '4176px',transform: 'translate3d(-1392px, 0px, 0px) '}}><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="-4" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="-3" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="-2" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="-1" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide" style={{width: '158px'}} tabIndex="-1" data-slick-index="0" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide" style={{width: '158px'}} tabIndex="-1" data-slick-index="1" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide" style={{width: '158px'}} tabIndex="-1" data-slick-index="2" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide" style={{width: '158px'}} tabIndex="-1" data-slick-index="3" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide slick-current slick-active" style={{width: '158px'}} tabIndex="0" data-slick-index="4" aria-hidden="false"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="0">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide slick-active" style={{width: '158px'}} tabIndex="0" data-slick-index="5" aria-hidden="false"><a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="0">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
    ...
    </a></div><div className="item slick-slide slick-active" style={{width: '158px'}} tabIndex="0" data-slick-index="6" aria-hidden="false"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="0">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-baby-care.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Baby Care</div>
    ...
    </a></div><div className="item slick-slide slick-active" style={{width: '158px'}} tabIndex="0" data-slick-index="7" aria-hidden="false"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="0">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Chicken, Meat &amp; Fish</div>
    ...
    </a></div><div className="item slick-slide" style={{width: '158px'}} tabIndex="-1" data-slick-index="8" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-cleaning-essentials.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Cleaning Essentials</div>
    ...
    </a></div><div className="item slick-slide" style={{width: '158px'}} tabIndex="-1" data-slick-index="9" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-pet-care.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Pet Care</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="10" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-dairy-bread-eggs.jpg" alt="Grocery Ecommerce Template" className="mb-3 img-fluid"/>
          <div className="text-truncate">Dairy, Bread &amp; Eggs</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="11" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-snack-munchies.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Snack &amp; Munchies</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="12" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-bakery-biscuits.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Bakery &amp; Biscuits</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="13" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-instant-food.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Instant Food</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="14" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-tea-coffee-drinks.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Tea, Coffee &amp; Drinks</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="15" id="" aria-hidden="true"><a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-atta-rice-dal.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Atta, Rice &amp; Dal</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="16" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-baby-care.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Baby Care</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="17" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Chicken, Meat &amp; Fish</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="18" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-cleaning-essentials.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Cleaning Essentials</div>
    ...
    </a></div><div className="item slick-slide slick-cloned" style={{width: '158px'}} tabIndex="-1" data-slick-index="19" id="" aria-hidden="true"> <a href="pages/shop-grid.html" className="text-decoration-none text-inherit" tabIndex="-1">
      <div className="card card-product mb-lg-4">
        <div className="card-body text-center py-8">
          <img src="assets/images/category/category-pet-care.jpg" alt="Grocery Ecommerce Template" className="mb-3"/>
          <div className="text-truncate">Pet Care</div>
    ...
    </a></div></div></div><span className="slick-next slick-arrow"><i className="feather-icon icon-chevron-right "></i></span></div>
    ...
    <div className="container">
      <div className="row">
        <div className="col-12 col-md-6 mb-3 mb-lg-0">
          <div>
            <div className="py-10 px-8 rounded"
        ...
        <div className="col-12 col-md-6 ">
          ...
          <div>
            <div className="py-10 px-8 rounded"
              style={{background:'url(assets/images/banner/grocery-banner-2.jpg)no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}}>
              <div>
    ...
    <div className="container">
      ...
      <div className="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3">
          ...
          <div className="card card-product">
            <div className="card-body">
              ...
              <h2 className="fs-6"><a href="pages/shop-single.html"
                  className="text-inherit text-decoration-none">NutriChoice Digestive </a></h2>
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              <div className="text-center position-relative"> <a href="pages/shop-single.html"><img
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Bakery &
                    Biscuits</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Cadbury 5
                  Star Chocolate</a></h2>
              <div className="text-warning">
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Snack &
                    Munchies</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Onion
                  Flavour Potato</a></h2>
              <div className="text-warning">
          ...
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Instant
                    Food</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Salted
          ...
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Dairy, Bread &
                    Eggs</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Blueberry
                  Greek Yogurt</a></h2>
              <div>
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Dairy, Bread &
                    Eggs</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Britannia
                  Cheese Slices</a></h2>
              <div className="text-warning">
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Instant
                    Food</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Kellogg's
                  Original Cereals</a>
              </h2>
              <div className="text-warning">
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Dairy, Bread &
                    Eggs</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Amul
                  Butter - 500 g</a></h2>
              <div className="text-warning">
  ...
  <section>
    <div className="container">
      ...
      <div className="row row-cols-lg-4 row-cols-1 row-cols-md-2 g-4 flex-nowrap">
        <div className="col">
          <div className=" pt-8 px-6 px-xl-8 rounded"
            style={{background:'url(assets/images/banner/banner-deal.jpg)no-repeat', backgroundSize: 'cover', height: '470px'}}>
            <div>
              <h3 className="fw-bold text-white">100% Organic
                Coffee Beans.
              </h3>
              <p className="text-white">Get the best deal before close.</p>
              <a href="#!" className="btn btn-primary">Shop Now <i className="feather-icon icon-arrow-right ms-1"></i></a>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Tea, Coffee &
                    Drinks</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Roast
                  Ground Coffee</a></h2>
              ...
              <div className="d-grid mt-2"><a href="#!" className="btn btn-primary ">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                    className="feather feather-plus">
                    <line x1="12" y1="5" x2="12" y2="19"></line>
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Fruits &
                    Vegetables</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Crushed
                  Tomatoes</a></h2>
              <div className="d-flex justify-content-between align-items-center mt-3">
                <div><span className="text-dark">$13</span> <span
                    className="text-decoration-line-through text-muted">$18</span>
        ...
        <div className="col">
          <div className="card card-product">
            <div className="card-body">
              ...
              <div className="text-small mb-1"><a href="#!" className="text-decoration-none text-muted"><small>Fruits &
                    Vegetables</small></a></div>
              <h2 className="fs-6"><a href="pages/shop-single.html" className="text-inherit text-decoration-none">Golden
                  Pineapple</a></h2>
              <div className="d-flex justify-content-between align-items-center mt-3">
                <div><span className="text-dark">$13</span> <span
                    className="text-decoration-line-through text-muted">$18</span>
...
<footer className="footer">
  <div className="container">
    ...
    <div className="border-top py-4">
      <div className="row align-items-center">
        <div className="col-md-6"><span className="small text-muted">Copyright 2023 © FreshCart eCommerce HTML Template.  All rights reserved. Powered by <a href="https://codescandy.com/">Codescandy</a>.</span></div>
