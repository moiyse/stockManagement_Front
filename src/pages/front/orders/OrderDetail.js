      ...
      <div className="row mb-8">
        <div className="col-md-12">
          <div className="d-md-flex justify-content-between align-items-center">
            ...
            <Link to={`/ordersList/`}>Back to all orders</Link></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="card-body p-6">
              <div className="d-md-flex justify-content-between">
                <div className="d-flex align-items-center mb-2 mb-md-0">
                  ...
                  <span className="badge bg-light-warning text-dark-warning ms-2">{order.status}</span>
                </div>
                {/* select option */}
                <div className="d-md-flex">
                  ...
                  <div className="ms-md-3">
                    ...
                    <a  className="btn btn-secondary">Download Invoice</a>
                  </div>
                </div>
              </div>
              <div className="mt-8">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-12">
                    <div className="mb-6">
                      ...
                      <p className="mb-1 lh-lg">{currentUser.username}<br />
                      {currentUser.email}<br />
                        +216 {currentUser.phoneNumber}</p>
                        <Link to={"/settings"}><a >View Profile</a></Link>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-6 col-md-6 col-12">
                    <div className="mb-6">
                      <h6>Order Details</h6>
                      <p className="mb-1 lh-lg">Order ID: <span className="text-dark">{order._id}</span><br />
                        Order Date: <span className="text-dark">{order.orderDate}</span><br />
                        Order Total: <span className="text-dark">{order.totalAmount} DT</span></p>
                    </div>
                  </div>
                </div>
              </div>
...
return (  <tr>
    <td>
      <a className="text-inherit">
        <div className="d-flex align-items-center">
          <div>
            <img src="../assets/images/products/product-img-1.jpg" alt="" className="icon-shape icon-lg" />
          </div>
    ...
    <td><span className="text-body">{product.price}</span></td>
            ...
            <div className="card-body p-6">
              <div className="row">
                <div className="col-md-6 mb-4 mb-lg-0">
                  <h6>Payment Info</h6>
                  <span className="badge bg-light-info text-dark-warning ms-2">{order.paymentMethod}</span>
                </div>
